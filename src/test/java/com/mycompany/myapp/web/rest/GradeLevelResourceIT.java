...
public class GradeLevelResourceIT {
    ...
    public void createGradeLevel() throws Exception {
        ...
        restGradeLevelMockMvc.perform(post("/api/grade-levels")
    ...
    public void updateGradeLevel() throws Exception {
        ...
        restGradeLevelMockMvc.perform(put("/api/grade-levels")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteGradeLevel() throws Exception {
        ...
        restGradeLevelMockMvc.perform(delete("/api/grade-levels/{id}", gradeLevel.getId())
