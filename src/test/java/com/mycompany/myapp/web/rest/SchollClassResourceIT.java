...
public class SchollClassResourceIT {
    ...
    public void createSchollClass() throws Exception {
        ...
        restSchollClassMockMvc.perform(post("/api/scholl-classes")
    ...
    public void updateSchollClass() throws Exception {
        ...
        restSchollClassMockMvc.perform(put("/api/scholl-classes")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteSchollClass() throws Exception {
        ...
        restSchollClassMockMvc.perform(delete("/api/scholl-classes/{id}", schollClass.getId())
