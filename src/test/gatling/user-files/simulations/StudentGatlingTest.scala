...
class StudentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Student entity")
        ...
        .repeat(2) {
            ...
            .get("/services/msapplication/api/students")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new student")
            .post("/services/msapplication/api/students")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/msapplication${new_student_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created student")
            .delete("/services/msapplication${new_student_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
