...
class SubjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Subject entity")
        ...
        .repeat(2) {
            ...
            .get("/services/msapplication/api/subjects")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new subject")
            .post("/services/msapplication/api/subjects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/msapplication${new_subject_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created subject")
            .delete("/services/msapplication${new_subject_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
